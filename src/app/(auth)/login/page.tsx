    ...
    <main className="grid min-h-screen bg-muted/40 lg:grid-cols-[0.95fr_1.05fr]">
      <section className="hidden border-r bg-[hsl(240_6%_10%)] p-10 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div>
          ...
          <h1 className="max-w-xl text-3xl font-semibold tracking-tight">Secure community operations for modern HOA teams.</h1>
          <p className="mt-5 max-w-lg text-white/70">Session handling is backed by Supabase Auth and tenant membership checks in the database.</p>
        </div>
      </section>
