...
export type SortableTableHeadProps = React.ThHTMLAttributes<HTMLTableCellElement> & {
...
const SortableTableHead = React.forwardRef<HTMLTableCellElement, SortableTableHeadProps>(
  ({ className, children, sorted, onSort, ...props }, ref) => (
    <TableHead ref={ref} className={cn(onSort && "cursor-pointer select-none", className)} {...props}>
      <button
        type="button"
      ...
      >
        ...
        {onSort && !sorted && <span aria-hidden="true" className="text-muted-foreground/50">↕</span>}
      </button>
    </TableHead>
  )
);
